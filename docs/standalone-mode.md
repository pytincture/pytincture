...
```bash
python -m pip install 'pytincture==1.0.0rc3'
...
`frontend/integrity/pytincture-1.0.0rc3.json` manifest before copying it. This
...
<script
  src="https://cdn.example/pytincture/1.0.0rc3/pytincture.min.js"
