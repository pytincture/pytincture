...
```bash
python -m pip install 'pytincture==1.0.0rc6'
...
`frontend/integrity/pytincture-1.0.0rc6.json` manifest before copying it. This
...
<script
  src="https://cdn.example/pytincture/1.0.0rc6/pytincture.min.js"
