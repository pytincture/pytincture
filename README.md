...
## Overview
`pyTincture` is a Python framework for browser interfaces with Python backends. Pyodide is the default browser runtime. This feature branch also supports opt-in MicroPython and Transcrypt clients through [experimental runtime selection](docs/browser-runtimes.md).
