...
```
<script src="https://cdn.jsdelivr.net/npm/@pytincture/runtime@1.0.0-rc.9/dist/pytincture.min.js" integrity="sha384-<trusted-manifest-value>" crossorigin="anonymous"></script>
```
